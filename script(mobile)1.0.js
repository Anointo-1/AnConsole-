...
function playNote(note, duration, timeOffset = 0) {
  ...
  osc.stop(startTime + duration);
   ...
   rand = [];
      for (let j = 0; j < 10; j++) {
      rand.push([Math.floor(Math.random() * 255), Math.floor(Math.random() * 255), Math.floor(Math.random() * 255)]);
      }
  vram.push(rand);
 }*/
...
function aBlur() {
  ...
  /*
 setTimeout(function () {
   fcc(20, 20, 20, 900, 0, 0, 0);
   }, 1000)
   console.log(Math);*/
   /*let code = ["c", "p", ":", "1", ",", "0", ",", "0", ",", "0", ",", "2", "3", "4", ";", "c", "p", ":", "0", ",", "0", ",", "0", ",", "0", ",", "0", "0", "0", ";"];
   runCode(code);*/